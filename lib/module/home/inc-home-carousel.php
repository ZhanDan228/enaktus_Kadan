					...
					<div class="video-con-container">
						...
						<div class='video-con-left'>
							<div class='video-con-wrapper'>
								...
								<div class='video-img-thumbnail' style="background: url('/img/photocarusel2.jpg') no-repeat center; background-size: cover;">
				...
				<div class="fill">
					...
					<div class='video-con-left'>
							<div class='video-con-wrapper'>
								...
								<div class='video-img-thumbnail' style="background: url('/img/photocarusel1.jpg') no-repeat center; background-size: cover;">
								<!-- <div class="video-img-overlay">
								</div> -->
								</div>
							</div>
